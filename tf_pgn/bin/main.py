...
import argparse
from seq2seq_pgn_tf2.train_eval_test import train, predict_result,evaluate
...
def main():
    ...
    parser.add_argument("--eval_seg_x_dir", default='{}/datasets/val_set.seg_x.txt'.format(BASE_DIR), help="test_seg_x_dir")
    parser.add_argument("--eval_seg_y_dir", default='{}/datasets/val_set.seg_y.txt'.format(BASE_DIR), help="test_seg_x_dir")
    ...
    parser.add_argument("--num_to_test", default=166, help="Number of examples to test", type=int)
