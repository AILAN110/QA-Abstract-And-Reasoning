...
import argparse
from seq2seq_transformer_pgn_tf2.train_eval_test import train, predict_result
...
def main():
    ...
    parser.add_argument("--batch_size", default=4, help="batch size", type=int)  #56
    ...
    parser.add_argument("--max_grad_norm", default=0.8, help="Gradient norm above which gradients must be clipped",
                        type=float)
    parser.add_argument('--cov_loss_wt', default=0.6, help='Weight of coverage loss (lambda in the paper).'
    ...
    parser.add_argument("--transformer_model_dir", default='{}/ckpt/transformer'.format(BASE_DIR), help="Model folder")
    ...
    parser.add_argument("--test_seg_x_dir", default='{}/datasets/val_set.seg_x.txt'.format(BASE_DIR), help="test_seg_x_dir")
    ...
    parser.add_argument("--test_x_dir", default='{}/datasets/AutoMaster_ValSet.csv'.format(BASE_DIR), help="test_x_dir")
    ...
    parser.add_argument("--num_to_test", default=166, help="Number of examples to test", type=int)   #20000
    parser.add_argument("--max_num_to_eval", default=166, help="max_num_to_eval", type=int)
    ...
    print('{}/datasets/train_set.seg_x.txt'.format(BASE_DIR))
