...
from seq2seq_transformer_pgn_tf2.models.transformer import PGN_TRANSFORMER
from seq2seq_transformer_pgn_tf2.batcher import batcher, Vocab
from seq2seq_transformer_pgn_tf2.train_helper import train_model
from seq2seq_transformer_pgn_tf2.test_helper import beam_decode
...
def train(params):
    ...
    checkpoint_dir = "{}/checkpoint".format(params["transformer_model_dir"])
    ckpt = tf.train.Checkpoint(step=tf.Variable(0), PGN_TRANSFORMER=model)
